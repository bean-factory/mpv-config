...
mp.add_key_binding("Ctrl+o", "add-files-kdialog", add_files)
mp.add_key_binding("Ctrl+Shift+o", "append-files-kdialog", append_files)
mp.add_key_binding("Ctrl+Shift+u", "open-url-kdialog", open_url_kdialog)
mp.add_key_binding("Ctrl+Shift+A", "add-subtitle-kdialog", add_sub_kdialog)
