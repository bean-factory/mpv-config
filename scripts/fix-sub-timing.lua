...
function sub_set_time()
    ...
    mp.osd_message("Synced subtitles")
...
function sub_clear()
    ...
    sub_time_2 = nil
    vid_time_2 = nil
    mp.osd_message("Clear sync marks")
end

mp.add_key_binding("ctrl+m", "sub-set-time", sub_set_time)
mp.add_key_binding("ctrl+shift+m", "sub-clear", sub_clear)
