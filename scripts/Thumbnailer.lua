...
local user_opts = {
    ...
    -- Worker
    max_workers           = 5,                  -- Number of active workers. Must have at least one copy of the worker script alongside this script.
    worker_remote_factor  = 0.2,                -- Multiply max_workers by this for remote streams or when MPV enables cache
